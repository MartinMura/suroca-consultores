...
export default function Nosotros(){
    return(
        <div className="home-width">
            <div className="container nosotros-top ">
                <div className="container frase-a bg-secondary text-light ">
                    <h1 className="consultora-title">LA CONSULTORA</h1>
                    <p className="consultora-p">Detectamos la problemática planteada por nuestros clientes y de común acuerdo iniciamos un análisis de auditoria interna para optimizar los procesos involucrados, mitigando riesgos y recomendando posibles alternativas para la mejora continua.</p>
                </div>
                ...
                <div className="mission-vission">
                    <h3 className="headings-mision">MISIÓN</h3>
                    <h6 className="headings-mision">¿Quiénes somos?</h6>
                    <p>Somos una consultora conformada por un grupo de  profesionales en ciencias económicas multifacéticos lo que nos permite poder tener una visión integral con cada cliente optimizando la posibilidad de encontrar mejores soluciones para los mismos, buscando la autorrealización y la satisfacción de los clientes.	</p>
                    <br />
                    <h6 className="headings-mision">¿En qué nos diferenciamos?</h6>
                    <p className="headings-mision">Estamos orientados a la mejora continua mediante la entrega de valor, haciendo que nuestros servicios sean sostenibles y sustentables en el tiempo.	</p>

                    <h3 className="headings-mision">VISIÓN</h3>
                    <p>Convertirnos en los profesionales referentes en el área mejora de procesos y ser reconocidos por brindar un servicio de excelencia y valor agregrado, logrando un impacto positivo tanto en la sociedad como en los miembros de la Consultora.</p>
                    <br />
                    <h3 className="headings-mision">VALORES</h3>
                    <ul>
                        <li>Calidad</li>
                        <li>Integridad</li>
                        <li>Compromiso</li>
